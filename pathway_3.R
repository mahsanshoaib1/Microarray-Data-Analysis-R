...
gene_data <- read_excel("D:/study/lab_projects/Dr_Zubair/Breast _cancer/practice_practical/Selected Datasets/outputs/overlapped/Grade_3_Common_genes.xlsx")
#view(gene_data)
...
write.csv(gse_go, "Grade_3_gse_go_results.csv")
...
# view(gse_kegg)
write.csv(gse_kegg, "Grade_3_gse_kegg_results.csv")
